...
extern int channel_create( int left, int right, int size);
extern void channel_send( int index, void * data);
extern void channel_receive(int index, int datasize, void * data);
extern void channel_terminate( int index);
